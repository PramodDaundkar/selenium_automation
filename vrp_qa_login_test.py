...
def test_complete_signup():
    ...
    chrome_driver.find_element(By.XPATH, "//input[@placeholder='Please enter a value in feet no less than 3 feet and no greater than 8 feet.']").send_keys(5)
    chrome_driver.find_element(By.XPATH, "//input[@placeholder='Please enter a value in inches no less than 0 inches and no greater than 11 inches.']").send_keys(11)
    chrome_driver.find_element(By.XPATH, "//input[@type='number']").send_keys(150.5)
    ...
    chrome_driver.find_element(By.XPATH, "//div[@class='display-flex']/div[2]//div[@ng-if = 'shouldShowLeftImage()']").click()
    chrome_driver.find_element(By.XPATH, "//button[@data-target='@form|button|continue']").click()
